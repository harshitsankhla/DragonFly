...
echo "2. librealsense"
echo "3. ceres-solver"
echo "4. QGroundControl"
echo "5. ROS Packages for - bluefox | xsens-imu | realsense | VINS Fusion | MAVROS | Octomap"
echo "6. Utilities - Sublime Text | Terminator | openssh | exFAT utils | tmux"
echo "7. MatrixVision Impact Driver for MonoCam"
echo -e '\n'
...
wget https://s3-us-west-2.amazonaws.com/qgroundcontrol/latest/QGroundControl.AppImage -P $HOME
